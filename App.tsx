...
// Sửa về đường dẫn tương đối vì App.tsx đang ở trong src cùng với components
...
// Key trong Map cũng cần đồng nhất với đường dẫn tương đối
const fileNameToRoute = new Map([
  ["./pages/admin.tsx", "/admin"],
  ["./pages/books.tsx", "/books"],
  ["./pages/login.tsx", "/login"],
  ["./pages/_index.tsx", "/"],
  ["./pages/profile.tsx", "/profile"],
  ["./pages/activities.tsx", "/activities"],
  ["./pages/my-journey.tsx", "/my-journey"],
  ["./pages/books.$bookId.tsx", "/books/:bookId"],
  ["./pages/admin.activities.$activityId.tsx", "/admin/activities/:activityId"]
]);
